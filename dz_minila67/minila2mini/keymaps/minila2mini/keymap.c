...
/* LAYER 1 / FUNCTION 1 (right of spacebar) - F-keys top row, left side Numberpad, right side Navigation keys:
  ...
  KEYMAP(
      ...
      KC_BSPC, KC_F1,  KC_F2,    KC_F3,      KC_F4,    KC_F5,  KC_F6,    KC_F7,      KC_F8,  KC_F9,  KC_F10,      KC_F11 , KC_F12,_______, KC_DEL,
      KC_ENT  ,KC_DEL , KC_P7 ,    KC_P8 ,     KC_P9 ,  KC_PPLS,KC_PAST,  KC_PGUP,    KC_UP, KC_PGDN,  KC_HOME,     _______, _______,     KC_ESC ,
      CAPSWRD   , KC_PDOT, KC_P4 ,   KC_P5 ,     KC_P6 ,  KC_PMNS,KC_PSLS,  KC_LEFT,    KC_DOWN, KC_RGHT,  KC_END,         KC_NLCK,     KC_TAB   ,
      DM_REC1     ,  KC_P0 , KC_P1 ,   KC_P2 ,     KC_P3 ,  KC_PEQL,_______,  KC_WH_D,     KC_WH_U,KC_WH_L, KC_WH_R,      KC_SLCK,KC_HOME, KC_INS,
      DM_PLY1    ,    KC_APP ,  _______,        MO(3) ,            _______       ,   _______,        _______,_______,     KC_PGUP, KC_END,KC_PGDN),
/* *** *** *** *** *** *** *** *** *** */
...
/* LAYER 2 / FUNCTION 2 (left side) - RGB LED controls, volume, laptop screen brightness, F-keys top row:
    ...
    KC_BSPC,  KC_F1,  KC_F2,    KC_F3,      KC_F4,    KC_F5,  KC_F6,    KC_F7,      KC_F8,  KC_F9,  KC_F10,      KC_F11 , KC_F12, _______,KC_DEL,
    KC_ENT  ,KC_HOME, KC_PGUP,   KC_UP,     KC_PGDN,  _______,_______,  KC_BTN1,  KC_MS_U, KC_BTN2,  _______,     _______, _______,      KC_ESC ,
    KC_DEL   , KC_END, KC_LEFT,  KC_DOWN,     KC_RGHT,  _______,_______,  KC_MS_L,    KC_MS_D, KC_MS_R, _______,         KC_NLCK,      KC_TAB   ,
    DM_REC2     , KC_WH_L,KC_WH_R, KC_WH_U,    KC_WH_D,  KC_CALC,_______,  _______,     _______,_______, _______,        KC_SLCK,KC_HOME, KC_INS,
    DM_PLY2    ,  KC_PSCR,  _______,        _______,            _______   ,       MO(3)  ,        _______,_______,      KC_PGUP, KC_END,KC_PGDN),
/* *** *** *** *** *** *** *** *** *** */


/* *** *** *** *** *** *** *** *** *** */
/* LAYER 3 - RGB, media controls, activating layers 4 (toggled movement-only) and 5 (on ESC key) where the Bootloader key is hidden:
	...
	KEYMAP(
    MO(5)  ,_______,_______, _______,     _______,  _______,_______,  _______,    _______,_______,_______,      _______,_______,_______,_______,
    _______ ,_______,RGB_HUD,  RGB_VAI,     RGB_HUI,  _______,_______,  KC_MPLY,    KC_BRIU,_______,_______,      _______, _______,   _______  ,
    _______   , _______,RGB_SAD, RGB_VAD,     RGB_SAI,  RGB_TOG,_______,  KC_VOLD,    KC_BRID,KC_VOLU,_______,         _______,      _______   ,
    _______     , _______,RGB_MOD, RGB_M_P,     RGB_M_SW,  _______,_______, _______,    _______,_______, _______,      KC_MPLY,KC_VOLU, _______,
    _______    ,  _______,  _______,        _______,             TG(4)       ,  _______,        _______,_______,     KC_MRWD, KC_VOLD, KC_MFFD),
/* *** *** *** *** *** *** *** *** *** */


/* *** *** *** *** *** *** *** *** *** */
/* LAYER 4 - Toggled movement-only layer for scrolling, arrows, page navigation one-handed on either side:
...
KEYMAP(
    ...
    _______ ,KC_HOME,KC_PGUP,  KC_UP,     KC_PGDN,  _______,_______,  KC_PGUP,    KC_UP, KC_PGDN,  KC_HOME,      _______, _______,   _______  ,
    _______   , KC_END,KC_LEFT, KC_DOWN,     KC_RGHT,  _______,_______,  KC_LEFT,    KC_DOWN, KC_RGHT,  KC_END,         _______,      _______   ,
    _______     , KC_WH_L,KC_WH_R, KC_WH_U,    KC_WH_D,  KC_SLCK,KC_SLCK,  KC_WH_D,     KC_WH_U,KC_WH_L, KC_WH_R,      KC_PGUP,KC_WH_U, KC_PGDN,
    _______    ,  _______,  _______,        _______,            _______      ,  _______,        _______,_______,     KC_WH_L, KC_WH_D, KC_WH_R),
/* *** *** *** *** *** *** *** *** *** */


/* *** *** *** *** *** *** *** *** *** */
/* LAYER 5 - Bootloader key hidden under two bottom row function keys + two top row corners (or fn1+fn2+esc+bkspc):
