...
/* LAYER 1 / FUNCTION 1 (right of spacebar) - F-keys top row, left side Numberpad, right side Navigation keys:
  ...
  KEYMAP(
      ...
      DM_REC1     ,  KC_P0 , KC_P1 ,   KC_P2 ,     KC_P3 ,  KC_PEQL,_______,  KC_WH_D,     KC_WH_U,KC_WH_L, KC_WH_R,      KC_SLCK,_______, KC_INS,
...
/* LAYER 2 / FUNCTION 2 (left side) - RGB LED controls, volume, laptop screen brightness, F-keys top row:
    ...
    KC_BSPC,  KC_F1,  KC_F2,    KC_F3,      KC_F4,    KC_F5,  KC_F6,    KC_F7,      KC_F8,  KC_F9,  KC_F10,      KC_F11 , KC_F12, _______,KC_DEL,
    KC_ENT  ,KC_DEL, _______,   _______,    _______,  _______,_______,  KC_BTN1,  KC_MS_U, KC_BTN2,  _______,     _______, _______,      KC_ESC ,
    CAPSWRD   , _______,_______,  _______,    _______,  _______,_______,  KC_MS_L,    KC_MS_D, KC_MS_R, _______,         KC_NLCK,      KC_TAB   ,
    DM_REC2     , KC_WH_L,KC_WH_R, KC_WH_U,    KC_WH_D,  KC_CALC,_______,  _______,     _______,_______, _______,        KC_SLCK,_______, KC_INS,
...
/* LAYER 3 - RGB, media controls, activating layers 4 (toggled movement-only) and 5 (on ESC key) where the Bootloader key is hidden:
    ...
    _______   , _______,RGB_SAD, RGB_VAD,     RGB_SAI,  RGB_TOG,_______,  KC_MRWD,    KC_VOLD,KC_MFFD,_______,         _______,      _______   ,
    _______     , _______,RGB_MOD, RGB_M_P,     RGB_M_SW,  _______,_______, _______,    _______,_______, _______,      _______,KC_BRIU, _______,
    _______    ,  _______,  _______,        _______,             TG(4)       ,  _______,        _______,_______,     _______, KC_BRID, _______),
/* *** *** *** *** *** *** *** *** *** */
...
KEYMAP(
    ...
    _______     , KC_WH_L,KC_WH_R, KC_WH_U,    KC_WH_D,  KC_SLCK,KC_SLCK,  KC_WH_D,     KC_WH_U,KC_WH_L, KC_WH_R,      _______,_______, _______,
