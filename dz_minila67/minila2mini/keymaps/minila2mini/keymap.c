...
/* LAYER 3 - RGB, media controls, activating layers 4 (toggled movement-only) and 5 (on ESC key) where the Bootloader key is hidden:
    ...
    _______     , _______,RGB_MOD, RGB_M_P,     RGB_M_SW,  _______,_______,    TG(4),    _______,_______, _______,      _______,KC_BRIU, _______,
...
KEYMAP(
    ...
    _______ ,KC-HOME,KC-PGUP,  KC-UP,     KC-PGDN,  _______,_______,  KC_PGUP,    KC_UP, KC_PGDN,  KC_HOME,      _______, _______,   _______  ,
    _______   , KC-END,KC-LEFT, KC-DOWN,     KC-RGHT,  _______,_______,  KC_LEFT,    KC_DOWN, KC_RGHT,  KC_END,         _______,      _______   ,
